...
public class Hibernates {
	...
	/**
	 * get connection from DataSoure, form jdbcUrl of metadata in the connection
	 * to decide Dialect type. support Oracle, H2, MySql, PostgreSql, SQLServer
	 */
