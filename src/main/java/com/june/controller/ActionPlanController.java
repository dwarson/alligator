...
public class ActionPlanController extends BaseController {
    ...
    private static String[] ACTION_PLAN_CONTEXT = { "Home", "Office", "Church",
            "Driving", "Shopping" };
    private static String[] ACTION_PLAN_URGENCY = { "Immediate", "Today",
            "This Week", "This Month", "This Year", "Next Year",
            "Next Few Year" };
    private static String[] ACTION_PLAN_ENERGY = { "Low Mental",
            "Low Physical", "Med Mental", "Med Physical", "High Mental",
            "High Physical" };
    private static String[] ACTION_PLAN_PRIORITY = { "Critical", "Important",
            "Not Critical", "Not Important" };
